...
The Enstratius console allows you to manage resources using three kinds of configuration
management systems: Chef, Puppet and the Enstratius Object Store.

**Chef**

Chef is a configuration management tool created by Opscode. Enstratius supports the three
